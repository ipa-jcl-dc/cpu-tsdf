...
//  principal_point_y_ = static_cast<float> (height_)/2. - 0.5;
  ...
  PCL_INFO ("Found PCD files with prefix: %s, poses with prefix: %s \n", pcd_prefix.c_str (), pose_prefix.c_str ());
